...
<div class="content">
    ...
    <div class="content__main container content__main-container" style="justify-content: center;">
        <div class="section-content_text form-layout-account active">
            <form action="/customer/account" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        ...
                        <div class="form-gruop dp-flex al-center">
                            <div class="img-user">
                                @if ($customer->avata !== null)
                                    <img src="{{asset('upload/images/customer-avata/'.$customer->avata)}}" alt="">
                                @else
                ...
                <div class="row">
                    <div class="col l-12 m-12 c-12">
                        <div class="form-gruop">
                            <input type="text" class="input" name="name" placeholder="Tên của bạn" value="{{$customer->name}}">
                ...
                <div class="row">
                    <div class="col l-12 m-12 c-12">
                        <div class="form-gruop">
                            <input class="input" name="phone" placeholder="Số điện thoại..." value="{{$customer->phone}}">
                ...
                <div class="row">
                    ...
                    <div class="col l-6 m-12 c-12">
                        <div class="form-gruop">
                            <input class="input" name="street_name" placeholder="Số nhà, tên đường..." value="{{$address[0]}}">
                ...
                <div class="row">
                    <div class="col l-12 m-12 c-12">
                        <div class="form-gruop dp-flex">
                            ...
                            <input type="radio" name="gender" id="male" value="nam" {{$customer->gender == 'nam' ? 'checked' : ''}}>
    
                            <label class="form-gruop__lbl" for="female">nữ</label>
                            <input type="radio" name="gender" id="female" value="nữ" {{$customer->gender  == 'nữ' ? 'checked' : ''}}>
    
                            <label class="form-gruop__lbl" for="orther">Khác</label>
                            <input type="radio" name="gender" id="orther" value="khác" {{$customer->gender == 'khác' ? 'checked' : ''}}>
                        </div>
        ...
        <div class=" section-content_text form-layout-account">
            <form action="/customer/account/change-password" method="post">
                @csrf
                <div class="row">
                    <div class="col l-12 m-12 c-12">
                        <div class="form-gruop">
