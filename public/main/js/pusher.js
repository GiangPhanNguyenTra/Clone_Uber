...
if (driverId) {
    ...
    channel.bind("new-booking-ride", function (data) {
        ...
        var htmlNoti = `<div class="notification -info">
                            ...
                            <a style="margin-top: 20px; color:white" href="/driver/accept/booking-ride/${ride.ride_id}">Xác nhận</a>
                        </div>`;
...
if (customerId) {
    ...
    // thông báo khi cuốc xe hoàn thành
    channel.bind("complete-booking-ride", function (data) {
        ...
        confirmModeContent.innerHTML = `<form action="/customer/rating/booking-ride" method="post">
                                        ...
                                        <div class="comment">
                                            <textarea style="resize: none" name="comment" id="" cols="50" rows="5"></textarea>
                                        </div>
                                        <button class="btn btn-intro">Gửi</button>
                                    </form>`;
        notifierOverlay.classList.add("active");
        confirmModel.classList.add("active");
    });
